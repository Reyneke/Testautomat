...
| E-43 | 2026-09-21 | Für die Produktion wird eine gehostete Postgres-Datenbank mit REST-Schicht und Token-Authentifizierung vorgesehen; die Anbieterwahl fällt vor dem ersten Release. | Passt zum REST-Vertrag; der Prototyp bleibt bei E-11. Für den Prototyp dokumentiert-offen: er nutzt weiterhin lokales SQLite bzw. InMemory (E-11); die Anbieterwahl betrifft erst die Produktionsumstellung. | `3_Git_Shenanigans.md`, `2_Datenbank.md` |

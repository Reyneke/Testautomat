-- Dokumentierte DDL des Datenlayers (Version 0002, aktueller Stand).
--
...
--
-- Aenderungen gegenueber 0001_initial.sql:
--   * `verkaeufe.zahlungsart` erlaubt zusaetzlich paypal, google_wallet, google_pay
--     (`7_Neue_Zahlmoeglichkeiten.md`).
--   * `verkaeufe.kennzeichen` nimmt das freiwillige Kfz-Kennzeichen auf (nullable).
--   * neue Tabelle `parkzonen` mit vier Seed-Zonen.
--
